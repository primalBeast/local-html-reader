# Borderless splash until Local HTML Reader's main window is ready.
# Closed when the named event LocalHtmlReader.SplashClose is signaled.
Add-Type -AssemblyName System.Windows.Forms
Add-Type -AssemblyName System.Drawing

$created = $false
$mutex = New-Object System.Threading.Mutex($true, "LocalHtmlReader.Splash", [ref]$created)
if (-not $created) { exit 0 }

Add-Type @"
using System.Runtime.InteropServices;
public static class LhrAppId {
  [DllImport("shell32.dll", CharSet = CharSet.Unicode)]
  public static extern int SetCurrentProcessExplicitAppUserModelID(string AppID);
}
"@
[void][LhrAppId]::SetCurrentProcessExplicitAppUserModelID("primalBeast.LocalHtmlReader")
...
$close = New-Object System.Threading.EventWaitHandle(
  ...
  "LocalHtmlReader.SplashClose"
)
$close.Reset() | Out-Null

$form = New-Object System.Windows.Forms.Form
$form.Text = "Local HTML Reader"
...
$caption.Text = "Local HTML Reader"
